  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow" id="1">
        ...
        <div className="py-16 bg-gray-100 h-screen flex items-center justify-center">
        ...
        <div className="py-16 bg-main-bg bg-fixed h-screen w-full -z-10 bg-no-repeat bg-cover text-white relative flex items-center">
          <div className="container mx-auto px-6 text-center">
