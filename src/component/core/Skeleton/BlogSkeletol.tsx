  ...
  return (
    <div className="my-20 w-full flex flex-col lg:flex-row justify-evenly">
      ...
      <div className=' flex justify-center px-3 h-[150] md:h-full'>
        <Skeleton variant="rectangular" animation="wave" height={skeletonHeight} width={skeletonWidth} style={{ borderRadius: '5px' }} />
      </div>

        <div className="mt-5">
          <h2 className="md:px-5 px-2">
            <Skeleton variant="text" animation="wave" height={70} width={isMobile ? '100%' : 600} />
          </h2>
          <div className="md:px-5 px-2 mt-3 text-base md:text-lg">
            <h3 className="font-semibold text-xl md:text-3xl my-6 md:my-12">
              <Skeleton variant="text" animation="wave" height={50} width={isMobile ? '100%' : 600} />
            </h3>
